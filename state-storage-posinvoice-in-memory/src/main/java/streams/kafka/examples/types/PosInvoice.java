...
package streams.kafka.examples.types;
...
public class PosInvoice {
    ...
    public PosInvoice withStorageID(String storageID) {
        this.storageID = storageID;
        return this;
    }
    ...
    public PosInvoice withPaymnetMethod(String paymnetMethod) {
        this.paymnetMethod = paymnetMethod;
        return this;
    }
    ...
    public PosInvoice withLineItems(LineItems lineItems) {
        this.lineItems = lineItems;
        return this;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("invoiceNumber", invoiceNumber).append("createdTime", createdTime).append("storageID", storageID).append("posID", posID).append("cashierID", cashierID).append("customerType", customerType).append("customerCardNo", customerCardNo).append("totalAmount", totalAmount).append("numberOfItems", numberOfItems).append("paymnetMethod", paymnetMethod).append("taxableAmount", taxableAmount).append("cGST", cGST).append("sGST", sGST).append("cESS", cESS).append("deliveryType", deliveryType).append("deliveryAddress", deliveryAddress).append("lineItems", lineItems).toString();
    }
